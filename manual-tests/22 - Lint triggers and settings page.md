...
Automated coverage: 15 former checks now live in test/sheet-22-lint-triggers-and-settings.test.ts and the smoke suite; run `npm test` and `npm run test:smoke` before this sheet.
