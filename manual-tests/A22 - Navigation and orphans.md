# A22: navigation and orphaned definitions

Settings: test once with popup OFF (classic jump), once ON (popup opens).
...
- [ ] Callout: press inside `[^cq]` below navigates to the definition INSIDE the callout, no duplicate minted at the bottom (2026-08-10); pressing on the callout's `[^cq]:` line jumps back

> [!note] A callout
> body[^cq] here
> [^cq]: callout definition

Orphan (QOL 2026-08-07) — caret on the orphan definition at the bottom,
press any footnote hotkey:
