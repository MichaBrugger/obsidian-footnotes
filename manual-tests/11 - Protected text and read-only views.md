# 11: protected text and read-only views

Automated coverage: 26 former checks now live in test/manual-protected-text.test.ts and the smoke suite; run `npm test` and `npm run test:smoke` before this sheet.
