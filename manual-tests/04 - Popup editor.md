...
Settings: `Edit footnotes in a popup` ON, defaults otherwise. Undo between checks. Every fixture is already in this note. The popup-OFF jumps are sheet 05.

Fixture reference to navigate from: jump me[^1] now. Decoy for the idle-note check: `[^name]: fake` sits in backticks on this line, and this note counts as idle once it has been saved.
