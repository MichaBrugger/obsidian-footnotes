...
- [ ] Same two selections, PASTE hotkey: the paste key's own redirect ("To turn the selected text into a footnote, use the auto-numbered, named, or inline footnote command."), not the one-stretch toast (2026-09-08)
