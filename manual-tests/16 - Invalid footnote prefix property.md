...
Automated coverage: 4 former checks now live in test/sheet-16-invalid-prefix-property.test.ts and the smoke suite; run `npm test` and `npm run test:smoke` before this sheet.
