...
- [ ] With the popup ON, open it on a definition whose body starts with a heading: the top of the heading sits level with the top of the `[^n]:` label, as in the core Footnotes view (tuned live 2026-09-09); a plain one-line definition lines up as before
