...
Automated coverage: 12 former checks now live in test/manual-navigation.test.ts and the smoke suite; run `npm test` and `npm run test:smoke` before this sheet.
