...
Automated coverage: 3 former checks now live in test/sheet-15-prefix-and-linter.test.ts and the smoke suite; run `npm test` and `npm run test:smoke` before this sheet.
