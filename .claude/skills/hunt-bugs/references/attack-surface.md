...
| `src/linting/linter.ts` | `lintFootnotes`, `LintOptions`, `reindexOptionsFromSettings`, `lintOptionsFromSettings`, auto-lint triggers (`installLintOnSave`, `noteActiveLeafForAutoLint`) | Composed lint pipeline + editor runner + save/file-change triggers |
