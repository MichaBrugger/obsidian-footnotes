...
| `src/commands/press-guards.ts` | `caretGuardsHandled`, `warnProtectedCaretIfInside`, `warnPrefilledReferenceIfInside`, `navigateDefinitionLabelIfInside` | A press was made — does something other than creation own it? Placeholder warnings, protected-caret refusal (Jason's 2026-08-12 rule), definition-label navigation |
