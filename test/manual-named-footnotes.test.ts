...
function plugin(doc: FakeEditor): FootnotePlugin {
    return sharedFakePlugin(
        {
            // sheet 01 runs on defaults with the popup off; the end-of-word
...
describe("sheet 01: the second press of the two-step named flow", () => {
...
describe("sheet 01: every command inside an empty '[^]' reference", () => {
...
describe("sheet 01: the name modal's refusals", () => {
