...
// Manual sheet 21, "lint stability paranoia", has one fixture and two
...
//
// This file replaces both boxes of sheet 21. Nothing is left for the sheet,
// so sheet 21 now says so in two lines.
//
...
describe("sheet 21: a definition on line 1 with a divider under it", () => {
...
describe("sheet 21: no churn on a second run", () => {
