...
// These tests take over four checks that used to sit on manual sheet 04
...
describe("a selection that cuts through inline math refuses (sheet 04)", () => {
...
describe("selections at a fenced code block's edges (sheet 04)", () => {
    const NOTE = [
...
describe("the fence selected ALONE (sheet 04, the 2026-09-09 fix)", () => {
