...
// These tests take over five checks that used to sit on manual sheet 03
...
describe("a footnote nothing references (sheet 03, the orphan section)", () => {
...
describe("jumping to a multi-line definition (sheet 03)", () => {
...
describe("uppercase footnote names navigate both ways (sheet 03)", () => {
    const NOTE = [
...
describe("a definition indented to a list item's margin (sheet 03, ruling 1)", () => {
