...
// These tests take over checks that used to sit on manual sheet 03
...
describe("sheet 03: the named hotkey inside a filled inline footnote", () => {
...
describe("sheet 03: the paste hotkey inside a reference that has a definition", () => {
