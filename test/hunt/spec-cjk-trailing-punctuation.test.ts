...
// endOfWordOffset hops ASCII trailing punctuation ("word." puts the marker
...
describe("spec question: CJK trailing punctuation vs. the end-of-word hop", () => {
    it.fails("hops a CJK full stop the way it hops an ASCII period", () => {
        // 中文。: an English word gets the marker after ".", a CJK user
        // expects the marker after "。" — the hop currently stops at 2
