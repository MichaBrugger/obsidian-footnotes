...
describe("fixed 2026-08-10: autonumber increments MAX_SAFE_INTEGER into an unsafe, unrescanable id", () => {
    it("does not reuse the first id created after MAX_SAFE_INTEGER", () => {
