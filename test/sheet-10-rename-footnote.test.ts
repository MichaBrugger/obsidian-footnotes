...
describe("sheet 10: renaming the fixture footnote", () => {
...
describe("sheet 10: the note's prefix and the apply-prefix lint rule", () => {
...
describe("sheet 10: the right-click menu's own lookup", () => {
...
describe("sheet 10: the command's palette check in Reading view", () => {
